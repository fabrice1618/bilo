...
<html lang="fr">
   ...
   <body class="h-screen w-full text-white" style="background: url(../assets/free.jpg); background-size: cover;">
      ...
      <div class="flex items-center justify-center h-4/5">
         <form class="w-1/5 border-2 border-white border-opacity-20 shadow-md backdrop-blur-20 flex items-center flex-col rounded-xl p-8" action="../backend/traitement_connexion.php" method="post">
            <h1 class="text-3xl font-bold p-6">Connexion</h1>
            ...
            <div class="">
               <p>Tu n'a pas de compte? <a class="font-bold hover:underline" href="inscription.php">Inscris-toi</a>
               </p>
            </div>
         </form>
      </div>
